        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="{{ route('admin.roles.edit', ['id' => $info->id_hash]) }}" class="kt-subheader__breadcrumbs-link">
                        تعديل مجموعة
                    </a>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="kt-portlet">
                ...
                <!--begin::Form-->
                <form class="kt-form kt-form--label-right" id="frmEdit" method="post" action="{{ route('admin.roles.edit', ['id' => $info->id_hash]) }}">
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            <div class="col-lg-6">
                                <label class="">اسم المجموعة:</label>
                                <input type="text" class="form-control" name="name" value="{{ $info->name }}" placeholder="اسم المجموعة">
                            </div>
                            <div class="col-lg-6">
