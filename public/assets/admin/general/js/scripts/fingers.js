...
var Fingers = function () {

    var view_tbl;
    var view_url = base_url + prefix + '/fingerPrint';
    var list_url = base_url + prefix + '/fingerPrint/list';
    var table_id = '#fingers_table';
    /////////////////// View //////////////////
    ///////////////////////////////////////////
    var viewTable = function () {
        ...
        var columns = [
            ...
            // {"data": "IndRegID", "orderable": true, "searchable": true},
            {"data": "MachineNumber", "orderable": true, "searchable": true},
            {"data": "InOutMode", "orderable": true, "searchable": true},
            {"data": "DateTimeRecord", "orderable": true, "searchable": false},
        ...
        var ajaxFilter = function (d) {
            ...
            d.MachineNumber = $('#MachineNumber').val();
            d.InOutMode = $('#InOutMode').val();
            d.status = $('#status').val();
        };
